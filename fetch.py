#!/usr/bin/env python3
"""
Recupero codici sconto Allianz da shopilo.it
Sursa: https://shopilo.it/negozi/allianz.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/allianz.it"
STORE_NAME = "Allianz"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Allianz da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-allianz)"
    }
    try:
